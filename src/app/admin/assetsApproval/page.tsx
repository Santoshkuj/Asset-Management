import { approveAsset, getPendingAssets, rejectAsset } from "@/actions/adminActions";
      ...
      {pendingAssets.length === 0 ? (
        <Card className="bg-white">
          <CardContent className="py-16 flex flex-col items-center justify-center">
            <p className="text-center">All assets have been reviewed</p>
          </CardContent>
        </Card>
      ) : (
